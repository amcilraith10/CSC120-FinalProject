...
//south objects
static GameObject station = new GameObject("station", "east", 3, "You see a high-speed rail station. It is very large and has several platforms, as well as trains and people moving through it. You spot a small card on the ground.");
static GameObject card = new GameObject("card", "east", 20, "You see a small card on the ground near the train tracks. It is a shiny metro card made of metal. You pick it up and put it in your pocket.");
static GameObject tracks = new GameObject("tracks", "east", 1, "Watch out! These tracks are dangerous if a train is coming. Stand clear!");
static GameObject platform = new GameObject("platform", "east", 1, "You see a train platform. It is very large and has many people moving through it.");
...
static GameObject statue = new GameObject("statue", "west", 1, "You see a large holographic statue of the university's mascot, the Dnaltrop Dragon. You watch the hologram for a moment and see the dragon breathing colorful pulses of fire.");
...
//underground objects
static GameObject tunnel = new GameObject("tunnel", "underground", 0, "You see a tunnel. It is very dark and you can barely see anything. The air is cool and wet. You start walking down the tunnel and see a small amount of yellow light at the end.");
static GameObject light = new GameObject("light", "underground", 0, "You see a small amount of yellow light at the end of the tunnel. You walk towards it. It is an old lamp attached to the wall of the tunnel. There is an old wooden door a few feet ahead at the end of the tunnel.");
static GameObject door = new GameObject("door", "underground", 0, "You see an old wooden door and knock. There is no answer. You try the handle. It is unlocked and swings open on rusty hinges.");
...
public static void explore(String name) {
   ...
   if (name.equals("fountain")) {
       ...
       System.out.println("Your total skill level is now " + skillLevel + ".");
        ...
        System.out.println("You have earned " + door.objectSkillLevel + " points.");
