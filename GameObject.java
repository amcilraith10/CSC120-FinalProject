...
//north objects
static GameObject fountain = new GameObject("fountain", "north", 100, "You see a beautiful fountain. It is made of glass and seems almost alive with bursts of water and lights. You see a few coins at the bottom of the fountain.");
...
static GameObject card = new GameObject("card", "east", 30, "You see a small card on the ground near the train tracks. It is a shiny metro card made of metal. You pick it up and put it in your pocket.");
...
static GameObject door = new GameObject("door", "underground", 0, "You see an old wooden door and knock. There is no answer. You try the handle. It is unlocked and swings open on rusty hinges. You suddenly remember where you are and everything around you is abruptly familiar.");
